...
export default function Home() {
  ...
  return (
    <div>
      {/* top */}
      <div className='flex flex-col gap-6 p-28 px-3 max-w-8xl mx-auto' id='perfect'>
        <h1 className='text-green-300 font-bold text-3xl lg:text-6xl text-center'>
          Let us guide you <span className='text-green-500'>home</span>
          <br />
        </h1>
        <div className='text-white text-md sm:text-2xl text-center'>
          Local Expertise | Global Presence
          <br />
        </div>
        <Link
          to={'/search'}
          className='text-sm lg:text-lg text-blue-400 font-bold hover:opacity-60 text-center'
        >
          Let's get started...
        </Link>
      </div>
        ...
        {offerListings && offerListings.length > 0 && (
          <div className=''>
            <div className='my-3'>
              ...
              <Link className='text-sm text-black hover:underline' to={'/search?offer=true'}>Show more offers</Link>
            </div>
